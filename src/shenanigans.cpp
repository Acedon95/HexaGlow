...
//    const char* ssid = "Vodafone-C9E6"; // Ersetzen Sie dies durch den Namen Ihres WLANs
//    const char* password = "NNeBQpc3muLL4EF4"; // Ersetzen Sie dies durch Ihr WLAN-Passwort
